...
# Create a dictionary mapping each bus to its associated measurements
bus_measurements = {}
...
sweep_config = {
    ...
    "parameters": {
        ...
        "activation": {"values": ["ReLU", "Tanh", "Sigmoid", "LeakyReLU"]},
...
sweep_id = wandb.sweep(sweep_config, project="FC_Hyperparameter_Tuning_AUS_P1R_complete_base")
